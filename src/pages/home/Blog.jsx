...
const Blog = () => {
  return (
    <div className="custom-container" style={{ marginTop: '100px' }}>
      <Heading
        heading="Latest Article and Insights"
        ...
        {blogs.map((blog, ) => (
          ...
          >
            <img
              src={blog.image}
              alt={blog.title}
              className="w-full h-48 object-cover transition hover:scale-110"
            />
            ...
            <div className="p-5">
              ...
              <p className="exit-sm text-gray-800 mb-5">{blog.description}</p>
