    ...
    <div className="custom-container" style={{ marginTop: "100px" }}>
      ...
      <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
        {pricingPlans.map((plan) => (
          <div
            key={plan.name}
            className="bg-white border-1 border-gray-200 rounded-lg overflow-hidden transition-all duration-300 hover:shadow-2xl"
          >
            <div className="p-5 text-center">
              ...
              <p className="text-gray-500 mb-5">
                Best For Plan {plan.name.toLowerCase()}s
              </p>
            ...
            <div className="p-5 text-center">
              <button className="bg-blue-400 text-white px-6 py-2 rounded-full hover:bg-blue-800 transition duration-300">
                Choose {plan.name}
              </button>
            </div>
